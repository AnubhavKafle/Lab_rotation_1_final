...
for (i in 1:35)
{
  TCGA_data[[case_filtered_lower[i]]]=getFirehoseData(dataset=cases_filtered[i], runDate=gisticDate[1], gistic2_Date=NULL,Clinic=FALSE, RNAseq_Gene=FALSE, mRNA_Array=FALSE, Mutation=TRUE); #Keep Mutation true and rest all false to selectively download mutation data
